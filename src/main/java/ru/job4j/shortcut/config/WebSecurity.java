...
public class WebSecurity extends WebSecurityConfigurerAdapter {
    ...
    private SimpleSiteService service;

    public WebSecurity(SimpleSiteService service, BCryptPasswordEncoder bCryptPasswordEncoder) {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, FIND_BY_SITE_URL).permitAll()
                .antMatchers(HttpMethod.GET, REDIRECT_SITE_URL).permitAll()
